...
/**
 * Serializes queries back to string format.
 *
...
public class QuerySerializer {
	...
	/**
	 * Serializes a query to its string representation.
	 * @param query the query to serialize
	 * @return the string representation
	 */
	public static String serialize(Query query) {
		return query.rootNode().accept(new SerializerVisitor());
	}
	...
	public static String serialize(Node node) {
		return node.accept(new SerializerVisitor());
	}
